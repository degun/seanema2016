		...
		function form($instance) {
			...
			<p class="description">
				<label for="<?php echo $this->get_field_id('color_scheme') ?>">
					Color scheme(applicable for tabs)<br/>
			...
			if($type == 'tab') {
				...
				$output .= '<div class="tabs ' . $class . '">';
					...
					foreach( $tabs as $tab ){
						...
						$output .= '<li class="'.$tab_selected.'"><a href="#aq-tab-' . $id . '-' . $i . '" data-toggle="tab">' . $tab['title'] . '</a></li>';
						$i++;
					}
					...
					foreach($tabs as $tab) {
						...
						$output .= '<div class="tab-pane ' . $tab_selected . '" id="aq-tab-' . $id . '-' . $i . '">' . wpautop(do_shortcode(htmlspecialchars_decode($tab['content']))) . '</div>';
				...
				$output .= '<div class="panel-group toggles" id="accordion">';
				
				foreach( $tabs as $tab ){

					$extra1 = $extra2 = ''; //used for the active accordion

					if($i == 1) {
						$extra1 = ' class="collapsed"';
						$extra2 = ' in';
					}
					...
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse-' . $id . '-' . $i . '" . ' . $extra1 . '>
                        ...
                        <div id="collapse-' . $id . '-' . $i . '" class="panel-collapse collapse ' . $extra2 . '">
                            <div class="panel-body">' . wpautop(do_shortcode(htmlspecialchars_decode($tab['content']))) . '</div>
                        </div>
                    </div>';
