...
if(!class_exists('AQ_Block')) {
	class AQ_Block {
	 	...
	 	function before_block($instance) {
	 		...
	 		$intsize = str_replace("span", "", $size);
	 		$class = ' col-sm-' . $intsize;

	 		//remove the bootstrap columns class for the section block
	 		if($id_base == 'aq_section_block' || $id_base == 'aq_title_block') {
	 			$class = '';
	 		}
	 		
	 		echo '<div id="aq-block-'.$template_id.'-'.$number.'" class="aq-block aq-block-'.$id_base . $class . ' no-padding clearfix">';
	 	}
