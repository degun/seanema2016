...
<div class="single-post">
	...
	<div class="post-left" <?php if($thumb != '') echo ' style="background-image: url(\'' . $thumb . '\')"';?>>
		<div class="post-left-content">
			<div class="logo"><a href="<?php echo site_url(); ?>"><?php bloginfo('name');?></a></div>
			<hr />
			<p class="post-info"><?php the_author_posts_link();?><br />
				<?php the_time( get_option( 'date_format' ) ); ?>
			</p>
			<p class="post-title"><?php the_title();?></p>
		</div> <!-- single-post-left-content -->
	</div><!--
	###################################
			...
			<div class="container-fuid">
                    ...
                    <div class="tags">
    	                ...
    	                foreach($tags as $tag) { 
    	                  	if($nrtags != count($tags) ) { ?>
    	                  		<a href="<?php echo get_term_link( $tag );?>" title="<?php echo sprintf(__('View all post filed under %s', 'teo'), $tag->name);?>"><?php echo $tag->name;?>, </a>
    	                  	<?php } else { ?>
    	                  		<a href="<?php echo get_term_link( $tag );?>" title="<?php echo sprintf(__('View all post filed under %s', 'teo'), $tag->name);?>"><?php echo $tag->name;?></a>
    	                	<?php }
    	                $nrtags++;
    	        ...
    	        <div class="comments">
					<div class="row">
						...
						<div class="col-sm-6">
							<?php comments_number( __('0 comments', 'teo'), __('1 comment', 'teo'), __('% comments', 'teo') ); ?>
						</div> <!-- end col-lg-6 -->
