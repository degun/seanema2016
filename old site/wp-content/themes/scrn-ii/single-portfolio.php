...
<div id="project-intro" <?php if($thumb != '') echo ' style="background-image: url(\'' . esc_url($thumb) . '\')"';?>>
	<div class="project-intro-bg">
		<div class="project-intro-content">
			<p class="project-title"><?php the_title();?><br />
				<span><?php echo implode(' + ', $cat_array);?></span>
			</p>
			<?php if($client != '') { ?>
				<p class="project-client"><?php echo __('client:', 'teo') . ' ' . esc_attr($client);?></p>
			<?php } ?>
		</div>
	</div> <!-- end project-intro-bg -->
</div> <!-- end project-intro -->

<div class="container">
	<?php if($description != '') { ?>
		<div class="project-description">
			<h3><?php _e('description', 'teo');?></h3>
...
<div class="more-projects">
	<div class="container">
		...
		<h4><?php _e('More projects', 'teo');?></h4>
	        ...
	        while($query->have_posts() ) : $query->the_post(); 
				...
				<div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
					<a href="<?php the_permalink();?>">
						<img src="<?php echo teo_Resize($thumb, 165, 130);?>" class="img-responsive" alt="<?php the_title();?>" />
					</a>
				</div> <!-- end col-lg-2 -->		
			<?php endwhile; wp_reset_postdata();?>	
	</div> <!-- end container -->
</div> <!-- end more-projects -->
