...
function teo_customizer( $wp_customize ) {
	...
	$wp_customize->add_section( 
		'teo_colorscheme_section' ,
		array(
			'title'       => __( 'Color Scheme', 'teo' ),
			'priority'    => 30,
			'description' => "Whether you want to use the orange or the cyan color scheme.",
		)
	);

	$wp_customize->add_setting( 'teo_color_scheme' );
	$wp_customize->add_control(
		'teo_color_scheme',
		array(
			'label'				=> 'Website Color Scheme',
			'section'			=> 'teo_colorscheme_section',
			'type'           	=> 'radio',
            'choices'        	=> array(
                1   		=> __( 'Orange (default)', 'teo' ),
                2  			=> __( 'Cyan', 'teo' ),
            ),
	...
	$wp_customize->add_section( 
		'teo_header_section' ,
		array(
			'title'       => __( 'Top Header Text + BG', 'teo' ),
			'priority'    => 30,
			'description' => 'The text and background image / colors used in the top area',
		)
	);

	$wp_customize->add_setting( 'teo_bgimage' );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'teo_bgimage', array(
		'label'    			=> 'Background Image',
		'section'  			=> 'teo_header_section',
		'settings' 			=> 'teo_bgimage',
		'sanitize_callback' => 'esc_url'
	) ) );

	//Left text

	$wp_customize->add_setting( 'teo_lefttext' );
	$wp_customize->add_control(
		'teo_lefttext',
		array(
			'label'				=> 'Left Big Text',
	...
	$wp_customize->add_setting( 'teo_righttext' );
	$wp_customize->add_control(
		'teo_righttext',
		array(
			'label'				=> 'Right Big Text',
			'section'			=> 'teo_header_section',
			'type'				=> 'text',
			'sanitize_callback'	=> 'esc_attr'
		)
	...
	$wp_customize->add_setting( 'teo_bgcolor_left' );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'teo_bgcolor_left', array(
		'label'    			=> 'Background color for left area(if used)',
		'section'  			=> 'teo_header_section',
		'settings' 			=> 'teo_bgcolor_left',
		'sanitize_callback' => 'esc_url'
	) ) );

	$wp_customize->add_setting( 'teo_bgcolor_left_opacity' );
	$wp_customize->add_control(
		'teo_bgcolor_left_opacity',
		array(
			'label'				=> 'Background color opacity for left area(if the color is used, 0-100 values)',
			'section'			=> 'teo_header_section',
			'type'				=> 'text',
	...
	$wp_customize->add_setting( 'teo_bgcolor_right' );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'teo_bgcolor_right', array(
		'label'    			=> 'Background color for right area(if used)',
		'section'  			=> 'teo_header_section',
		'settings' 			=> 'teo_bgcolor_right',
		'sanitize_callback' => 'esc_url'
	) ) );

	$wp_customize->add_setting( 'teo_bgcolor_right_opacity' );
	$wp_customize->add_control(
		'teo_bgcolor_right_opacity',
		array(
			'label'				=> 'Background color opacity for right area(if the color is used, 0-100 values)',
			'section'			=> 'teo_header_section',
			'type'				=> 'text',
			'sanitize_callback'	=> 'intval',
			'default'     => '40',
	...
	$wp_customize->add_setting( 'teo_introtitle' );
	$wp_customize->add_control(
		'teo_introtitle',
		array(
			'label'				=> 'Intro Title (shows below the area with the big text)',
			'section'			=> 'teo_header_section',
			'type'				=> 'text',
			'sanitize_callback'	=> 'esc_attr'
		)
	...
	$wp_customize->add_setting( 'teo_introtext' );
	$wp_customize->add_control(
		'teo_introtext',
		array(
			'label'				=> 'Intro Description Text (shows below the area with the big text)',
			'section'			=> 'teo_header_section',
			'type'				=> 'textarea',
			'sanitize_callback'	=> 'esc_attr'
		)
	...
	$wp_customize->add_section( 
		'teo_footer_section' ,
		array(
			'title'       => __( 'Footer Contact Area', 'teo' ),
			'priority'    => 30,
			'description' => 'The details for the contact area',
		)
	);

	$wp_customize->add_setting( 'teo_contact_subtitle' );
	$wp_customize->add_control(
		'teo_contact_subtitle',
		array(
			'label'				=> 'Contact page subtitle(if used)',
	...
	$wp_customize->add_setting( 'teo_contact_email' );
	$wp_customize->add_control(
		'teo_contact_email',
		array(
			'label'				=> 'E-mail address(shown above the contact form)',
			'section'			=> 'teo_footer_section',
			'type'				=> 'text',
			'sanitize_callback'	=> 'esc_attr'
		)
	...
	$wp_customize->add_setting( 'teo_contact_phone' );
	$wp_customize->add_control(
		'teo_contact_phone',
		array(
			'label'				=> 'Phone number(shown above the contact form)',
			'section'			=> 'teo_footer_section',
			'type'				=> 'text',
			'sanitize_callback'	=> 'esc_attr'
		)
	...
	$wp_customize->add_setting( 'teo_contact_location' );
	$wp_customize->add_control(
		'teo_contact_location',
		array(
			'label'				=> 'Location(shown above the contact form)',
			'section'			=> 'teo_footer_section',
			'type'				=> 'textarea',
			'sanitize_callback'	=> 'esc_attr'
		)
	...
	$wp_customize->add_setting( 'teo_contact_mapimg' );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'teo_contact_mapimg', array(
		'label'    			=> 'Map image(shows below the form)',
		'section'  			=> 'teo_footer_section',
		'settings' 			=> 'teo_contact_mapimg',
		'sanitize_callback' => 'esc_url'
	) ) );

	$wp_customize->add_setting( 'teo_contact_mapiframe' );
	$wp_customize->add_control(
		'teo_contact_mapiframe',
		array(
			'label'				=> "Map iframe code(if  you don't want to use an image)",
			'section'			=> 'teo_footer_section',
			'type'				=> 'textarea',
			'sanitize_callback'	=> 'esc_attr'
		)
	...
	$wp_customize->add_section( 
		'teo_social_section' ,
		array(
			'title'       => __( 'Footer Social', 'teo' ),
			'priority'    => 31,
			'description' => 'Provide social media profiles',
		)
	);

	$wp_customize->add_setting( 'teo_social_facebook' );
	$wp_customize->add_control(
		'teo_social_facebook',
		array(
			'label'				=> 'Facebook URL',
	...
	$wp_customize->add_setting( 'teo_social_googleplus' );
	$wp_customize->add_control(
		'teo_social_googleplus',
		array(
			'label'				=> 'Google+ URL',
			'section'			=> 'teo_social_section',
			'type'				=> 'text',
	...
	$wp_customize->add_setting( 'teo_social_dribbble' );
	$wp_customize->add_control(
		'teo_social_dribbble',
		array(
			'label'				=> 'Dribbble URL',
	...
	$wp_customize->add_setting( 'teo_social_behance' );
	$wp_customize->add_control(
		'teo_social_behance',
		array(
			'label'				=> 'Behance URL',
	...
	$wp_customize->add_setting( 'teo_social_youtube' );
	$wp_customize->add_control(
		'teo_social_youtube',
		array(
			'label'				=> 'YouTube URL',
	...
	$wp_customize->add_setting( 'teo_social_codepen' );
	$wp_customize->add_control(
		'teo_social_codepen',
		array(
			'label'				=> 'CodePen URL',
	...
	$wp_customize->add_setting( 'teo_social_stumbleupon' );
	$wp_customize->add_control(
		'teo_social_stumbleupon',
		array(
