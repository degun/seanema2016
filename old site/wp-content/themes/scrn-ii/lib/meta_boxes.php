...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array( // Text Input
				...
				'desc'  => 'The page title, will show up in the header. If empty, the post title will be used.', // description
				'id'    => $prefix . 'title', // field id and name
				'type'  => 'text', // type of field,
				'std' => ''
			),
			array( // Text Input
				'name' => 'Subtitle text', // <label>
				'desc'  => 'Short text that will show up above the page title', // description
				'id'    => $prefix . 'subtitle', // field id and name
				'type'  => 'text', // type of field,
				'std' 	=> ''
			),
			array( // Text Input
			    'name' => 'Separator title text (if used)', // <label>
			    'desc'  => 'The block that shows up below the page itself, as a separator between the current page and the next one). ', // description
			    'id'    => $prefix . 'separator_title', // field id and name
			    'type'  => 'text', // type of field,
			    ),
			array( // Text Input
			    'name' => 'Separator description text (if used)', // <label>
			    'desc'  => 'The block that shows up below the page itself, as a separator between the current page and the next one). ', // description
			    'id'    => $prefix . 'separator_description', // field id and name
			    'type'  => 'textarea_small', // type of field,
			    ),
			array( // Text Input
			    'name' => 'Separator background image(if you want a custom one)', // <label>
			    'desc'  => 'The background image of the separator block(if used)', // description
			    'id'    => $prefix . 'separator_bg', // field id and name
			    'type'  => 'file', // type of field,
			    ),
			array( // Text Input
			    'name' => 'Separator button text (if used)', // <label>
			    'desc'  => 'The button text for the separator block(if you want a button). ', // description
			    'id'    => $prefix . 'separator_buttontext', // field id and name
			    'type'  => 'text', // type of field,
			    ),
			array( // Text Input
			    'name' => 'Separator button URL (if used)', // <label>
			    'desc'  => 'The button URL for the separator block(if you want a button). ', // description
			    'id'    => $prefix . 'separator_buttonurl', // field id and name
			    'type'  => 'text', // type of field,
			    ),
		)
	);
	...
	$meta_boxes[] = array(
		'id'         => 'blog_metabox',
		'title'      => 'Blog page template details',
		'show_on'    => array( 'key' => 'page-template', 'value' => array('page-template-blog.php') ),
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'fields' => array(
			array( // Text Input
			    'name' => 'Number of posts shown on the homepage', // <label>
			    'desc'  => 'The number of posts shown on the homepage(in case the blog page is shown on the homepage) ', // description
			    'id'    => $prefix . 'nrposts', // field id and name
			    'type'  => 'text', // type of field,
			    ),
			array( // Text Input
			    'name' => 'Categories included on the blog page', // <label>
			    'desc'  => 'The categories included on the blog page', // description
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			array( // Text Input
				...
				'desc'  => 'The name of the client, shows up on the header section.', // description
				'id'    => $prefix . 'client', // field id and name
				'type'  => 'text', // type of field,
				'std' => ''
			),
			array( // Text Input
				'name' => 'Project description', // <label>
				'desc'  => 'Small description about the project', // description
