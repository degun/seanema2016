...
if(!class_exists('AQ_Service_Block')) {
	class AQ_Service_Block extends AQ_Block {
		...
		<p class="description half">
			<label for="<?php echo $this->get_field_id('number') ?>">
				Number on the background(e.g. 01, 02, 03):
				<?php echo aq_field_input('number', $block_id, $number, $size = 'full') ?>
			</label>
		</p>

		<p class="description half last">
			<label for="<?php echo $this->get_field_id('service_name') ?>">
				Service name:
				<?php echo aq_field_input('service_name', $block_id, $service_name, $size = 'full') ?>
			</label>
		</p>
		...
		<p class="description half">
			<label for="<?php echo $this->get_field_id('category1') ?>">
				Category 1:
				<?php echo aq_field_input('category1', $block_id, $category1, $size = 'full') ?>
			</label>
		</p>
		...
		<p class="description half last">
			<label for="<?php echo $this->get_field_id('category2') ?>">
				Category 2:
				<?php echo aq_field_input('category2', $block_id, $category2, $size = 'full') ?>
			</label>
		</p>
		...
		<p class="description half">
			<label for="<?php echo $this->get_field_id('category3') ?>">
				Category 3:
				<?php echo aq_field_input('category3', $block_id, $category3, $size = 'full') ?>
			</label>
		</p>

		<p class="description half last">
			<label for="<?php echo $this->get_field_id('category4') ?>">
				Category 4:
				<?php echo aq_field_input('category4', $block_id, $category4, $size = 'full') ?>
			</label>
		</p>

		<p class="description half">
			<label for="<?php echo $this->get_field_id('category5') ?>">
				Category 5:
				<?php echo aq_field_input('category5', $block_id, $category5, $size = 'full') ?>
			</label>
		</p>

		<p class="description half last">
			<label for="<?php echo $this->get_field_id('category6') ?>">
				Category 6:
				<?php echo aq_field_input('category6', $block_id, $category6, $size = 'full') ?>
			</label>
		</p>
	...
	function block($instance) {
		...
		if($service_name != '') {
			echo '<p class="service-type-title">' . esc_attr($service_name) . '</p>';
		}

		if($description != '') {
			echo '<p class="service-type-text">' . esc_attr($description) . '</p>';
		}
		...
		if(count($categories) > 0) {
			echo '<ul class="left-list list-unstyled">';
			for($i = 0; $i < (int)count($categories) / 2; $i++) {
				echo '<li>' . esc_attr($categories[$i]) . '</li>';
			}
			echo '</ul>';

			echo '<ul class="right-list list-unstyled">';
			for($i = (int)count($categories) / 2; $i < count($categories); $i++) {
				echo '<li>' . esc_attr($categories[$i]) . '</li>';
			}
			echo '</ul>';
		}
		...
		if($number != '') {
			echo '<div class="service-type-number">' . esc_attr($number) . '</div>';
		}
