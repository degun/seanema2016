...
if(!class_exists('AQ_Process_Block')) {
	class AQ_Process_Block extends AQ_Block {
		...
		function __construct() {
			$block_options = array(
				'name' => 'Process (timeline with 4 "stories")',
				'size' => 'span12',
			);
		...
		<p class="description half last">
			<label for="<?php echo $this->get_field_id('description1') ?>">
				Story 1 description:
				<?php echo aq_field_input('description1', $block_id, $description1, $size = 'full') ?>
			</label>
		</p>
		...
		<p class="description half last">
			<label for="<?php echo $this->get_field_id('description2') ?>">
				Story 2 description:
				<?php echo aq_field_input('description2', $block_id, $description2, $size = 'full') ?>
			</label>
		</p>
		...
		<p class="description half last">
			<label for="<?php echo $this->get_field_id('description3') ?>">
				Story 3 description:
				<?php echo aq_field_input('description3', $block_id, $description3, $size = 'full') ?>
			</label>
		</p>
		...
		<p class="description half">
			<label for="<?php echo $this->get_field_id('title4') ?>">
				Story 4 title:
				<?php echo aq_field_input('title4', $block_id, $title4, $size = 'full') ?>
			</label>
		</p>

		<p class="description half last">
			<label for="<?php echo $this->get_field_id('description4') ?>">
				Story 4 description:
				<?php echo aq_field_input('description4', $block_id, $description4, $size = 'full') ?>
			</label>
		</p>
	...
	function block($instance) {
		...
		echo '<ul class="process-list list-unstyled list-inline">';

		if($title1 != '' || $description1 != '') {
			echo '<li>';
			if($title1 != '') {
				echo '<h4>' . esc_attr($title1) . '</h4>';
			}
			if($description1 != '') {
		...
		if($title3 != '' || $description3 != '') {
			echo '<li>';
			if($title3 != '') {
				echo '<h4>' . esc_attr($title3) . '</h4>';
			}
			if($description3 != '') {
				echo '<p>' . esc_attr($description3) . '</p>';
			}
		}
		...
		if($title4 != '' || $description4 != '') {
			echo '<li>';
			if($title4 != '') {
				echo '<h4>' . esc_attr($title4) . '</h4>';
			}
			if($description4 != '') {
				echo '<p>' . esc_attr($description4) . '</p>';
			}
		}

		echo '</ul>';

		echo '<div class="process-image"></div>';
