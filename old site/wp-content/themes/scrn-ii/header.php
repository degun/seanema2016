...
<head>
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4e6e101c448ecbed" async="async"></script>
...
<body <?php body_class();?>>
    <!-- navigation ################################### -->
    <?php if(is_page_template('page-template-homepage.php') && is_front_page() ) { ?>
        <nav class="pushy pushy-right">
            <?php wp_nav_menu(array(
                ...
                'echo' => true,
                'walker' => new teo_description_walker(),
                'depth' => 0 ) );
            ?>
        </nav>
    <?php } else { ?>
    ...
    <?php if(!is_single() || (is_single() && get_post_type() == 'portfolio') ) { 
                ...
                <div class="container-fuid">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="logo"><a href="<?php echo site_url(); ?>/#intro" <?php if(is_page_template('page-template-homepage.php') && is_front_page() ) echo ' data-scroll';?>><?php if($logo != '') echo '<img alt="' . get_bloginfo('name') . '" src="' . esc_url($logo) . '" />'; else bloginfo('name');?></a></div>
                        </div> <!-- end col-lg-6 -->
