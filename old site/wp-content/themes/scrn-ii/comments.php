...
<div id="comments" class="comments col-sm-12">
	...
	<?php if ( ! comments_open() ) : ?>
		<div class="post-inside">
			<p class="no-comments"><?php _e( 'Comments are closed.', 'teo' ); ?></p>
		</div>
	<?php endif; ?>
	...
	<?php if ('open' == $post->comment_status) : ?>
		...
		'author' => '
	            ...
	            <input id="author" placeholder="John Doe(*)" name="author" type="text" value="' . $name . '" ' . $aria_req . ' />
	        </div>',
		'email'  => '
	            <label for="name">' . __('E-mail', 'teo') . ':</label>
				<input id="email" placeholder="john@doe.com(*)" name="email" type="text" value="' . $email . '" ' . $aria_req . ' />',
		'url'    => '
	            <label for="name">' . __('Name', 'teo') . ':</label>
				<input id="url" placeholder="http://example.com" name="url" type="text" value="' . $url . '" />'
		); 

		$comment_textarea = '
	            <label for="message">Message:</label>
	            <textarea placeholder="Your Message...(*)" id="comment" name="comment" aria-required="true"></textarea>';
		comment_form( array( 'fields' => $fields, 'comment_field' => $comment_textarea, 'id_submit' => 'contact_submit', 'label_submit' => esc_attr__( 'Submit Comment', 'teo' ), 'title_reply' => '<div class="post-section">' . esc_attr__( 'Leave a Reply', 'teo' ) . '</div>', 'title_reply_to' => '<div class="post-section">' . esc_attr__( 'Leave a Reply to %s', 'teo' ) . '</div>') ); ?>		
